...
function Registration() {
    ...
    return (
        <div className='min-h-screen w-full bg-gradient-to-br from-[#0b1315] via-[#111a1f] to-[#070b0d] text-white flex flex-col relative overflow-hidden'>
            ...
            {/* Main Form Container */}
            <main className='flex-1 flex flex-col items-center justify-center px-4 relative z-10 w-full py-10'>
                
                {/* Titles */}
                <div className='text-center mb-8 flex flex-col gap-2'>
                    <h2 className='text-3xl md:text-4xl font-bold tracking-tight'>Create an Account</h2>
                    <p className='text-gray-400 text-md'>Join OneCart and start placing your orders</p>
                </div>
